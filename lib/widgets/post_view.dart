...
class _PostViewState extends State<PostView> {
  ...
  _initPostLiked() async{
    bool isLiked = await DatabaseService.didLikePost(currentUserId: widget.currentUserId, post: widget.post);
    //don't understand what 'mounted' does here
    if(mounted){
      setState(() {
        _isLiked = isLiked;
      });
  ...
  _likePost(){
    if(_isLiked){
      //unlike Post
      DatabaseService.unlikePost(currentUserId: widget.currentUserId, post: widget.post);
      setState(() {
        _isLiked = false;
      ...
      //like Post
      DatabaseService.likePost(currentUserId: widget.currentUserId, post: widget.post);
      setState(() {
        _heartAnim = true;
        _isLiked = true;
        _likeCount = _likeCount + 1;
